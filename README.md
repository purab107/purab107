...
🎓 <strong>Final year CSE student</strong>  
Losing sleep over bugs and loving every second of it.

💻 <strong>Into:</strong>  
Full-stack Web Dev (Angular, React, Node, MongoDB)  
Prompt Engineering (talking to AIs more than humans)  
Blockchain (because centralization is so last season)

🚀 <strong>Currently learning:</strong>  
DSA (aka brain gym) & backend wizardry

🧠 <strong>Ask me about:</strong>  
Tech stuff, dumb bugs, or how I survived 100 tabs crashing Chrome

😅 <strong>Fun fact:</strong>  
I once debugged for 6 hours... turns out I forgot a semicolon. 🙃
